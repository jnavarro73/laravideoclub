...
<form action="{{ url('/catalog/create') }}" method="POST" role="form" enctype="multipart/form-data">
  
  {{ method_field('PUT') }}
  {{ csrf_field() }}
 
  <fieldset>
    <legend>Añadir mensaje</legend>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
          ...
          name="synopsis" class="@error('synopsis') is-invalid @enderror">
          </textarea>
          @error('synopsis')
          <div class="alert alert-danger">{{ $message }}</div>
          @enderror
